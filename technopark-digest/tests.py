...
def main():
    ...
    check("русский шаблон ловит заголовок с заглавной",
          extract.normalize("Технопарк Академии наук Туркменистана развивает проекты",
                            "x")["park"] == "Академии наук Туркменистана")
    check("русский глагол не попадает в название",
          extract.normalize("Технопарк Академии наук внедряет цифровые технологии",
                            "x")["park"] == "Академии наук")
